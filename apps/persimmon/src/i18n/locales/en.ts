...
export const en = {
  ...
  settings: {
    ...
    developer: {
      ...
      websiteAccessibility: "Open Qihang Yang's website, chihum.dev",
      websiteFailedTitle: "Could Not Open Developer Website",
      websiteFailedMessage:
        "Try again later or visit chihum.dev in your browser.",
    },
  },
  reader: {
    toolbar: {
