...
export const fr = {
  ...
  settings: {
    ...
    sourceCode: {
      ...
      description:
        "Forkez le projet, signalez des problèmes ou contribuez au code",
  ...
  reader: {
    ...
    settings: {
      ...
      textAlignmentBook: "Selon le livre",
      textAlignmentStart: "Début",
      textAlignmentJustify: "Justifié",
      textAlignmentEnd: "Fin",
      textAlignmentValueAccessibility:
        "Alignement du texte, actuellement {{value}}",
    },
    fonts: {
      section: "Police",
      unavailable:
    ...
    tuning: {
      ...
      title: "Réglage de la courbe de changement de page",
      clickMode: "Appui",
      gestureMode: "Geste",
      forwardMode: "Suivant",
      backwardMode: "Précédent",
      reverseReleaseX: "Atterrissage inverse · releaseX",
      reverseCurvatureRelaxation: "Courbure inverse · curvatureRelaxation",
      incomingLandingStartProgress: "Courbure initiale · landingStart",
      incomingRevealStartProgress: "Dos du papier visible · revealStart",
      incomingRevealEndProgress: "Dos entièrement visible · revealEnd",
      incomingDragProgressScale: "Suivi de la main · dragScale",
      incomingDragProgressExponent: "Courbe de réponse · dragExponent",
      incomingSettleDurationSeconds: "Durée d’atterrissage · settleDuration",
      incomingSettleEasingPower: "Lissage d’atterrissage · settleEasing",
      incomingRevertDurationSeconds: "Durée de retour · revertDuration",
      clickReleaseX: "Début du soulèvement · releaseX",
      clickLiftVelocity: "Vitesse de soulèvement · liftVelocity",
      clickLiftToLeft: "Étendue horizontale · liftToLeft",
      ...
      playbackSpeed: "Vitesse de lecture · playbackSpeed",
      propagationSpeed: "Vitesse de propagation {{value}}",
      reverseHint: "Réglages de page entrante et du dos",
      resetAccessibility: "Rétablir les valeurs du mode sélectionné",
      reset: "Réinitialiser le mode",
    },
  ...
  errors: {
    ...
    library: {
      ...
      exportUnavailable:
        "Cet appareil ne peut pas ouvrir la feuille d’exportation de fichiers.",
      exportFailed: "L’EPUB n’a pas pu être exporté. Réessayez.",
