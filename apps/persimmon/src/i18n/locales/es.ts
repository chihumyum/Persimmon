...
export const es = {
  ...
  settings: {
    ...
    sourceCode: {
      label: "Visitar el repositorio",
      description: "Haz un fork, informa de problemas o contribuye al código",
      accessibility: "Abrir el código fuente de Persimmon en GitHub",
      failedTitle: "No se pudo abrir el código fuente",
      failedMessage:
        "Inténtalo de nuevo más tarde o visita github.com/chihumyum/Persimmon en tu navegador.",
    },
  },
  reader: {
    toolbar: {
    ...
    settings: {
      ...
      textAlignmentBook: "Según el libro",
      textAlignmentStart: "Al inicio",
      textAlignmentJustify: "Justificado",
      textAlignmentEnd: "Al final",
      textAlignmentValueAccessibility:
        "Alineación del texto, actualmente {{value}}",
    },
    fonts: {
      section: "Fuente",
      unavailable:
    ...
    tuning: {
      ...
      title: "Ajuste de la curva de giro de página",
      clickMode: "Toque",
      gestureMode: "Gesto",
      forwardMode: "Adelante",
      backwardMode: "Atrás",
      reverseReleaseX: "Aterrizaje inverso · releaseX",
      reverseCurvatureRelaxation: "Curvatura inversa · curvatureRelaxation",
      incomingLandingStartProgress: "Curvatura inicial · landingStart",
      incomingRevealStartProgress: "Aparece el reverso · revealStart",
      incomingRevealEndProgress: "Reverso totalmente visible · revealEnd",
      incomingDragProgressScale: "Seguimiento de la mano · dragScale",
      incomingDragProgressExponent: "Curva de respuesta · dragExponent",
      incomingSettleDurationSeconds: "Duración de caída · settleDuration",
      incomingSettleEasingPower: "Suavizado de caída · settleEasing",
      incomingRevertDurationSeconds: "Duración de retorno · revertDuration",
      clickReleaseX: "Inicio del levantamiento · releaseX",
      clickLiftVelocity: "Velocidad de levantamiento · liftVelocity",
      clickLiftToLeft: "Extensión horizontal · liftToLeft",
      ...
      playbackSpeed: "Velocidad de reproducción · playbackSpeed",
      propagationSpeed: "Velocidad de propagación {{value}}",
      reverseHint: "Controles de página entrante y reverso",
      resetAccessibility: "Restaurar los valores del modo seleccionado",
      reset: "Restablecer actual",
    },
    loading: {
  ...
  errors: {
    ...
    library: {
      ...
      exportUnavailable:
        "Este dispositivo no puede abrir el panel de exportación de archivos.",
      exportFailed: "No se pudo exportar el EPUB. Inténtalo de nuevo.",
